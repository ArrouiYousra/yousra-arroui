...
const Navigation = () => {
  ...
  return (
    <>
      ...
      <aside className={`sidebar ${isSidebarOpen ? 'sidebar-open' : ''}`}>
        <div className="sidebar-header">
          <div className="sidebar-logo">
            <span className="logo-text">Yousra Arroui</span>
          </div>
        ...
        <nav className="sidebar-nav">
          ...
          <a href="#skills" className="sidebar-link" onClick={closeSidebar}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <a href="#cv" className="sidebar-link" onClick={closeSidebar}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      {/* Menu Toggle Button */}
      <button className={`menu-toggle ${isSidebarOpen ? 'menu-open' : ''}`} onClick={toggleSidebar}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
